...
class Stats(commands.Cog):
  ...
  async def stats(self, ctx, ign):
    ...
    for frame in ImageSequence.Iterator(im):
      ...
      I1.text((28, 100), f"Discord - {userdiscord}", font=myFontSize, fill =statsclr)
      I1.text((28, 130), f"Guild - {await functions.returnGuild(ign)}", font=myFontSize, fill =statsclr)
